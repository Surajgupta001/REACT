...
function App() {
  ...
  return (
    <div className="container mx-auto p-4 pt-6">
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg p-4 bg-gray-700 text-orange-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button
            ...
            className="outline-none bg-blue-700 text-white px-2 py-0.5 shrink-0 hover:bg-blue-800 transition duration-300"
          >
            Copy
          </button>
        </div>
